    ...
    public SentenceList getTicketsList() {
        ...
        StaticSentence staticSentence = new StaticSentence(s,
                new QBFBuilder(
                        ...
                        + "ON C.ID = T.CUSTOMER LEFT OUTER JOIN people P ON T.PERSON = P.ID "
                        + "WHERE ?(QBF_FILTER) "
                        + "GROUP BY T.ID, T.TICKETID, T.TICKETTYPE, R.DATENEW, P.NAME, C.NAME, PM.notes, T.serie_number "
                        + "ORDER BY R.DATENEW DESC, T.TICKETID",
                        new String[]{
...
// For productBundle
    ...
    public final TableDefinition getTableTaxes() {
        return new TableDefinition(s,
                "taxes",
                new String[]{"ID", "NAME", "CATEGORY", "CUSTCATEGORY", "PARENTID", 
                    "RATE", "RATECASCADE", "RATEORDER", "LEGALCODE", "DATESTART"},
                new String[]{"ID", AppLocal.getIntString("label.name"), AppLocal.getIntString("label.taxcategory"), 
                    ...
                    AppLocal.getIntString("label.order"), AppLocal.getIntString("label.LegalCode"),
                    AppLocal.getIntString("label.date")},
                new Datas[]{Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, 
                    Datas.DOUBLE, Datas.BOOLEAN, Datas.INT, Datas.STRING, Datas.TIMESTAMP},
                new Formats[]{Formats.STRING, Formats.STRING, Formats.STRING, Formats.STRING, Formats.STRING, 
                    Formats.PERCENT, Formats.BOOLEAN, Formats.INT, Formats.STRING, Formats.DATE},
                new int[]{0}
        );
    }
