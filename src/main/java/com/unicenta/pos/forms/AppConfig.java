...
public class AppConfig implements AppProperties {
  ...
  private void setDatabaseProperties(Properties properties, String dirname) {
    ...
    // Default database
    properties.setProperty("db.driverlib", new File(new File(dirname), "mariadb-java-client-2.7.10.jar").getAbsolutePath());
    ...
    properties.setProperty("db.schema", "mestizo");
    properties.setProperty("db.options", "?zeroDateTimeBehavior=convertToNull");
    properties.setProperty("db.user", "mestizo");
